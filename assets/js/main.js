(() => {
  // ===== Kontakt popover (spouštěj jen když existuje) =====
  ...
  // ===== Lightbox pro .gallery img – vždy nezávisle =====
  ...
  const open = (i) => { idx = i; img.src = srcFor(thumbs[idx]); overlay.removeAttribute('hidden'); document.documentElement.style.overflow='hidden'; btnClose.focus(); };
